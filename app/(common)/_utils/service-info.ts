...
`,
    ...
    <p>
    khi những đứa trẻ bắt đầu hiểu thế nào là yêu thương, là gia đình…  <br/>
    thì ông bà có thể đã không còn nữa.
    </p>
      ...
      <br/>
      <p>
        <b>Không chỉ con bạn. Mà chính bạn - cũng có thể quay lại những ngày ấy.</b>
        <br/>
        Ngồi lại bên mâm cơm có đủ ba thế hệ. 
        <br/>
        Nghe lại những lời dặn dò tưởng chừng rất bình thường… nhưng sau này, không gì có thể thay thế.
      </p>
  ...
  },
  {
    ...
    description: `
     <b>Không phải ai cũng có thể trở về nhà...</b>
      <ul class="default-list">
    ...
    <p>
      ...
      <b class="text-orange-700">Mà là mở ra một cách khác để được ở bên nhau.</b>
    </p>
`,
    ...
    videoSrcTitle: `Công nghệ mở ra 1 cánh cửa khác để đoàn viên`,
    postFixUrl: SERVICE_POSTFIX_URLS.FAMILY,
    reverse: true,
    fullDescription: `<h4 class="text-xl text-center text-gray-500 mb-6">
        <b>Sự đoàn viên không còn bị giới hạn bởi không gian</b>
      </h4>
      ...
      <div class="text-center mb-8 mt-2">
              <div class="flex justify-center py-4">
                  <img 
                      src="/imgs/nhung-so-phan-dac-biet.png" 
                      alt="Khoảnh khắc gia đình đoàn viên" 
                      class="w-full aspect-video xl:w-64 xl:h-40 object-cover rounded-lg shadow-md"
                  >
              </div>
              <p class="font-semibold text-gray-600">
                  VR - Không chỉ là công nghệ
                </p>
      </div>
       <b>Hãy tưởng tượng… dù bạn đang ở bất cứ đâu </b>
      <p> 
        <b class="text-lg text-gray-700 leading-relaxed mb-6">
         Bạn vẫn có thể “trở về”
        </b> - không phải bằng một chuyến xe, mà bằng một không gian 3D qua kính Thực tế ảo.
      </p>

      <ul class="default-list">
        <li>Không phải trước 1 màn hình lạnh lẽo.</li>
        <li>Không còn là cuộc gọi vội vã.</li>
        <li>Mà là một khoảnh khắc đoàn viên thực sự</li>
      </ul>

  <div class="p-4 bg-background bg-[#913e1f17] my-2 text-gray-500">
    <p>
      Ở đó, người ở xa có thể trở về. <br/>
      Người không thể bước ra ngoài… vẫn có thể “đi đến”.
    </p>
  </div>
  <p>Không phải là thay thế thực tại.
  <b class="text-orange-700">Mà là mở ra một cách khác để được ở bên nhau.</b></p> <br/>
        <div class="text-center mb-8 mt-2">
          <div class="flex justify-center">
              <img 
                  src="/imgs/tham-lai-gia-dinh-o-xa.png" 
